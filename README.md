...
- На странице может быть огромное количество карточек, однако обрабатываться они должны поочерёдно, поэтому нет смысла делать сразу список со всему карточками и хранить его в памяти.
...
- КРАЙНЕ ВАЖНО, ЧТОБЫ КОД РАБОТАЛ КОРРЕКТНО, ДАЖЕ ЕСЛИ НА СТРАНИЦЕ БОЛЬШОЕ КОЛИЧЕСТВО КАРТОЧЕК!!!!
